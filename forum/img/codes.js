...
l_help = "Список: [list]текст[/list][list]текст[/list]... (alt+l)";
o_help = "Список с №: [listn]1.строка[/list][listn]2.строка[/list]... (alt+o)";
w_help = "Вставить ссылку: (url)http://url(/url)  (alt+w)";
a_help = "Закрыть все открытые теги";
bbcode = new Array();
bbtags = new Array('[b]','[/b]','[i]','[/i]','[u]','[/u]','[q]','[/q]','[list]','[/list]','[listn]','[/listn]','(url)','(/url)');
imageTag = false;
